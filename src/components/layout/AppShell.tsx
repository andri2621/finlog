      ...
      <div className="w-full max-w-md min-h-screen flex flex-col bg-[var(--background)] shadow-2xl relative border-x border-[var(--border-color)]">
        ...
        <header className="sticky top-0 z-40 bg-white/90 dark:bg-[var(--background)]/90 backdrop-blur-md px-4 py-3 border-b border-slate-200 dark:border-[var(--border-color)] flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            {/* Offline / Sync Badge */}
            {!syncStatus.isOnline ? (
              <span className="inline-flex items-center gap-1 text-[11px] font-medium bg-amber-500/10 text-amber-600 dark:text-amber-400 border border-amber-500/30 px-2 py-0.5 rounded-full animate-pulse">
              ...
              <button
                type="button"
                onClick={() => syncNow()}
                className="inline-flex items-center gap-1 text-[11px] font-medium bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-500/30 px-2 py-0.5 rounded-full hover:bg-blue-500/20 transition-all cursor-pointer touch-manipulation"
              >
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative" ref={profileMenuRef}>
              ...
              {/* User Dropdown Menu */}
              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-60 bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl p-2 z-50 animate-in fade-in zoom-in-95 duration-100">
